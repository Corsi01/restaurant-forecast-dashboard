...
def plot_trend_holidays(model, metadata, selected_metric):
    """
    Create a single plot showing Trend + Holidays effects
    Uses historical data WITHOUT regressors to show clean holiday effects
    """
    ...
    # Add holidays (Italian national holidays)
